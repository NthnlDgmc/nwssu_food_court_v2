      ...
      <div class="w-full max-w-sm text-center">
        ...
        <div class="flex items-center gap-2 mt-5">
          <a
            ...
            class="flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5 border border-gray-200 text-gray-700 text-xs font-semibold hover:bg-gray-50 transition-colors rounded-[3px]"
          >
            Go Back
          </a>
          <a
