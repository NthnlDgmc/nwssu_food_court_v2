      ...
      <div class="max-w-5xl mx-auto px-4 pt-3 pb-4 flex flex-col gap-3">
        ...
        <div class="bg-white border border-gray-200 p-3 shadow-sm rounded-md">
          <div class="flex gap-2">
            ...
            <div class="relative">
              <button type="button" id="stallFilterBtn" class="h-full px-3.5 py-2 bg-white border border-gray-200 text-xs font-normal text-gray-700 flex items-center gap-1.5 whitespace-nowrap focus:outline-none focus:border-emerald-600 rounded-[3px]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
    ...
    function setupStallFilter() {
      ...
      document.addEventListener("click", function(e) {
        if (!e.target.closest("#stallFilterBtn") && !e.target.closest("#stallFilterDropdown")) {
          ...
          stallFilterBtn.classList.remove("border-emerald-600");
        }
      });
