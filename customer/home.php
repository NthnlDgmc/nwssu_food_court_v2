...
<button type="button" id="openFilterBtn" class="relative h-full px-3 py-2 bg-emerald-600 border border-emerald-600 text-white hover:bg-emerald-700 flex items-center justify-center focus:outline-none focus:border-emerald-700 rounded-[3px]">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-white">
                ...
                <div class="food-banner-carousel" id="foodBannerCarousel" aria-label="Featured food banners">
          <div class="food-banner-viewport" id="foodBannerViewport">
            <div class="food-banner-track" id="foodBannerTrack">
          ...
          <div class="food-banner-controls" aria-label="Banner controls">
            <button type="button" class="food-banner-control" id="foodBannerPause" aria-label="Pause banner autoplay" title="Pause autoplay">
              <svg id="foodBannerPauseIcon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-4 h-4" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 5.25v13.5m7.5-13.5v13.5" />
              </svg>
            </button>
            <button type="button" class="food-banner-control" id="foodBannerFullscreen" aria-label="View banner fullscreen" title="View fullscreen">
          ...
          <div class="food-banner-dots" id="foodBannerDots" aria-label="Choose a banner">
  ...
  <div
    ...
    <div id="foodBannerLightbox" class="fixed inset-0 z-[70] hidden items-center justify-center px-4" aria-hidden="true">
    <div id="foodBannerLightboxOverlay" class="absolute inset-0 bg-black/80"></div>
    <button type="button" id="foodBannerLightboxClose" class="food-banner-lightbox-close" aria-label="Close banner viewer" title="Close">
    ...
    <img id="foodBannerLightboxImage" src="" alt="" class="food-banner-lightbox-image" />
  </div>
  ...
  <script>
    ...
    function setupLoadMore() {
      document.getElementById("loadMoreBtn").addEventListener("click", function() {
        ...
        function setupFoodBannerCarousel() {
      const carousel = document.getElementById("foodBannerCarousel");
      const viewport = document.getElementById("foodBannerViewport");
      const track = document.getElementById("foodBannerTrack");
      const dots = Array.from(document.querySelectorAll(".food-banner-dot"));
      const fullscreenBtn = document.getElementById("foodBannerFullscreen");
      const pauseBtn = document.getElementById("foodBannerPause");
      const pauseIcon = document.getElementById("foodBannerPauseIcon");
      ...
      function updatePauseControl() {
        const isPaused = isAutoplayPaused;
        pauseBtn.setAttribute("aria-label", isPaused ? "Resume banner autoplay" : "Pause banner autoplay");
        pauseBtn.setAttribute("title", isPaused ? "Resume autoplay" : "Pause autoplay");
      ...
      const lightbox = document.getElementById("foodBannerLightbox");
      const lightboxOverlay = document.getElementById("foodBannerLightboxOverlay");
      const lightboxClose = document.getElementById("foodBannerLightboxClose");
      const lightboxImage = document.getElementById("foodBannerLightboxImage");
