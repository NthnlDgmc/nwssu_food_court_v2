    ...
    <div class="w-full max-w-sm">
      ...
      <div class="rounded-md bg-white border border-gray-200 shadow-sm p-4 space-y-4">
        <div
          ...
          <p class="text-[10px] text-red-600 font-medium leading-none" id="formErrorMsg"></p>
        </div>
        ...
        <div class="bg-gray-50 border border-gray-200 p-3 space-y-3 rounded-[3px]">
          ...
          <p class="text-[10px] text-gray-400 leading-relaxed">
            ...
            cannot be edited here. If anything is incorrect, please contact
            the admin to have it corrected.
          </p>
        </div>
